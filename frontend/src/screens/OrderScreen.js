          ...
          <ListGroup variant='flush'>
            <ListGroup.Item>
              ...
              {order.isDelivered ? (
                <Message
                  variant='success'
                  message={`Delevired on ${order.deliveredAt.substring(0, 10)}`}
                ></Message>
              ) : (
            ...
            <ListGroup.Item>
              ...
              {order.orderItems.length === 0 ? (
                <Message message='Order is empty'></Message>
              ) : (
                <ListGroup variant='flush'>
          ...
          <Card>
            <ListGroup variant='flush'>
              ...
              {!order.isPaid && (
                <ListGroup.Item>
                  {loadingPay && <Loader />}
                  {errorPay && <Message variant='danger' message={errorPay} />}
                  {!sdkReady ? (
                    <Loader />
                  ) : (
                    <PayPalButton
              ...
              {userInfo &&
                ...
                !order.isDelivered && (
                  <ListGroup.Item>
                    ...
                    {errorDeliver && (
                      <Message variant='danger' message={errorDeliver} />
                    )}
                    <Button
                      type='button'
